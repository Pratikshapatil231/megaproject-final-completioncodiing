            ...
            <nav id="primary-menu" class="navbar navbar-fixed-top">
                ...
                <span class="icon-bar"></span>
                 ...
                 <a class="logo" href="index.php">
                    <strong style="color:#34495e; font-size:18px;">Home Town</strong>
                </a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse pull-right" id="navbar-collapse-1">
                        <ul class="nav navbar-nav nav-pos-center navbar-left" >
                            ...
                            <li><a href="properties-grid.php" style="color:#000">properties</a></li>

                            <li><a href="contact.php" style="color:#000">contact</a></li>
                              <!-- Profile Menu-->
                            <li class="has-dropdown" style="color:#000 !important">
                                <?php if (strlen($_SESSION['remsuid']!=0)) {?>
                                <a href="#" data-toggle="dropdown" class="dropdown-toggle menu-item" style="color:#000 !important"> My Account</a>
                                <ul class="dropdown-menu" >
                                    <li><a href="user-profile.php" style="color:#000">user profile</a></li>
                                    <li><a href="change-password.php" style="color:#000">change password</a></li>
                               ...
                               <?php if (strlen($_SESSION['remsuid']==0)) {?>
                            <li>
                                <a href="admin/login.php" style="color:#000">admin</a>
                        ...
                        <div class="module module-login pull-left">
                            <?php if (strlen($_SESSION['remsuid']==0)) {?>  
                            <a class="btn-popup" data-toggle="modal" data-target="#signupModule" style="color:#000">Login</a>
                            <?php } ?>
                                                    ...
                                                    <div class="tab-pane" id="signup">
                                                        <form class="mb-0" method="post" name="signup">
                                                           ...
                                                           <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="text" class="form-control" name="mobilenumber" pattern="[789][0-9]{9}" id="mobilenumber" maxlength="10" required="true"  placeholder="Mobile Number">
                                                            </div>
                                                            <div class="form-group">
                                                                <input type="password" class="form-control" name="password" id="password" required="true" placeholder="Password">
                                                            </div>
